...
class blog extends CI_Controller implements CrudModelInterface {
    ...
    public function getList()
    {
        ...
        $viewData->model=$this->db->get('blog')->result();
        $viewData->createBtn="blog/credit";
        $this->load->view("blog/List", $viewData);
    ...
    public function credit()
    {
        $viewData=new stdClass();
        $viewData->model=null;
        $viewData->action="blog/savechange?type=1&id=0";
        $this->load->view("blog/credit",$viewData);
    }
    ...
    public function  isActiveSetter(){
        ...
        $this->db->where("id", $id)->update("blog", array("isActive" => $isActive));

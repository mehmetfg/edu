...
class student extends CI_Controller implements CrudModelInterface {
    ...
    public function getList()
    {
        ...
        $viewData->model=$this->db->get('student')->result();
        $viewData->createBtn="student/credit";
        $this->load->view("student/List", $viewData);
    ...
    public function credit()
    {
        $viewData=new stdClass();
        $viewData->model=null;
        $viewData->action="student/savechange?type=1&id=0";
        $this->load->view("student/credit",$viewData);
    }
    public function saveChange()
    {
        $name = $this->input->post("studentName");
        $mail=$this->input->post("studentMail");
        $data=array(
            "Name"=> $name,
            "Mail"=>$mail
        );

        saveChange("student",$data);
    ...
    public function  isActiveSetter(){
        ...
        $this->db->where("id", $id)->update("student", array("isActive" => $isActive));

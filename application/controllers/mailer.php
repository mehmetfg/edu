...
class mailer extends CI_Controller implements CrudModelInterface {
    ...
    public function getList()
    {
        ...
        $viewData->model=$this->db->get('mailer')->result();
        $viewData->createBtn="mailer/credit";
        $this->load->view("mailer/List", $viewData);
    ...
    public function credit()
    {
        $viewData=new stdClass();
        $viewData->model=null;
        $viewData->action="mailer/savechange?type=1&id=0";
        $this->load->view("mailer/credit",$viewData);
    }
    public function saveChange()
    {
        $name = $this->input->post("mailerName");
        $mail=$this->input->post("mailerMail");
        $data=array(
            "Name"=> $name,
            "Mail"=>$mail
        );

        saveChange("mailer",$data);
    ...
    public function  isActiveSetter(){
        ...
        $this->db->where("id", $id)->update("mailer", array("isActive" => $isActive));
